...
\newcommand{\susana}[1]{\textcolor{green}{{\bf  #1}}}
...
\newcommand*{\tchannel}{\ensuremath{t}-channel\xspace}
\newcommand*{\schannel}{\ensuremath{s}-channel\xspace}
...
%\newcommand*{\BDT}{\ensuremath{\text{BDT}}\xspace}
...
\newcommand{\pnutopz}{\ensuremath{p^{\Pnu, \text{top}}_z}\xspace}
\newcommand{\pnutopT}{\ensuremath{p^{\Pnu, \text{top}}_{\text{T}}}\xspace}
\newcommand{\phinutop}{\ensuremath{\phi^{\Pnu, \text{top}}}\xspace}
...
\newcommand{\pltopT}{\ensuremath{p^{\Plepton, \text{top}}_{\text{T}}}\xspace}
\newcommand{\philtop}{\ensuremath{\phi^{\Plepton, \text{top}}}\xspace}
\newcommand{\phibtop}{\ensuremath{\phi^{\Pbottom, \text{top}}}\xspace}
...
\newcommand{\toprecomass}{\ensuremath{m_{\text{top}}^{\text{reco}}}\xspace}
