...
\input{latex/mycommands.tex} % Set of commands
...
% Inner cover
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Others/InsideCover}

\frontmatter % Roman page number
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Certification page
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Others/Certifico}
...
% Preface
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Others/Preface}
...
\fancyfoot[C]{\thepage}
%\include{Chapters/Others/Acknowledgements}
...
% CONTENTS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Others/Contents}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Chapter_3/Chapter_3_1}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Object reconstruction and identification
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Chapter_3/Chapter_3_2}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Analysis Polarisation 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\include{Chapters/Chapter_4/Chapter_2_Polarisation}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Analysis tHq 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Chapter_5/Chapter_tH}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Conclusion
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\include{Chapters/Chapter_6/Chapter_Conclusion} 
...
% Analysis tools
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\include{Chapters/Chapter_Polarisation/Chapter_2_Polarisation}
...
\begin{appendices}
\input{Chapters/Others/Appendices/Appendix_NegativeWeights}
\input{Chapters/Others/Appendices/Appendix_BDT}
\input{Chapters/Others/Appendices/Appendix_thqLoop}
\input{Chapters/Others/Appendices/Appendix_TopPartons}
\input{Chapters/Others/Appendices/Appendix_BDT_Variables}
%\input{Chapters/Others/Appendices/Appendix_OtherFits}
\input{Chapters/Others/Appendices/Appendix_AdditionalResults}
...
% Abbreviations 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{Chapters/Others/Abbreviations}
...
%\include{Chapters/Others/Summary}
%\include{Chapters/ThesisSummary/Summary_Spanish}
\include{Chapters/ThesisSummary/Summary_Valencian}
\end{otherlanguage}
...
% CONTRAPORTADA
%\input{Chapters/Others/Abstract}
