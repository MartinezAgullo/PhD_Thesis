...
%\hspace*{140pt} ---\textsc{William Edwards Deming} \\% \textit{} \\ %(1900-1993)
%\vspace*{2cm} 
...
\hspace*{240pt} ---\textsc{Vicent Andrés Estellés} \\% \textit{} \\
\hspace*{265pt}     \textsc{Coral romput (1971)} \\% \textit{} \\
\vspace*{2cm} 


%\vspace*{0.1 cm} 
%\hspace*{200pt} \\
%\hspace*{120pt} \textit{If you torture data long enough, it will confess to anything.} \\
%\hspace*{140pt} ---\textsc{Seen on a Youtube comment} \\
%\vspace*{2cm} 
...
\begin{figure}[h]
 	  \centering
	\includegraphics[width = 0.76\textwidth]{Chapter2/PDF_mstw2008nnlo68cl_allpdfs_A_B}
...
\begin{figure}[h]
 	  \centering
	\includegraphics[width = 0.45\textwidth]{Chapter2/ProtonProton_Phenomenology_ByMe}
...
\begin{figure}[h]
 	  \centering
	\includegraphics[width = 0.88\textwidth]{Chapter3/UnderlyingEvent_ByMe}
...
\begin{figure}
	\centering
 	 \includegraphics[width = 0.6\textwidth]{Chapter2/Pile-up_Runs_1234.pdf}
...
by comparing, at each level, the real-detector data with the simulated event data.
 ...
 \begin{figure}
    \centering
    \includegraphics[width = 0.75\textwidth]{Chapter3/SimulationVSRealityChain.pdf}
...
\begin{figure}[h]
 	 \centering
 	  \includegraphics[width = 0.6\textwidth]{Chapter2/intlumivsyear_extended}
...
\begin{figure}[h]
 	 \centering
 	  \includegraphics[width = 0.6\textwidth]{Chapter2/intlumivstimeRun2DQall}
...
\POWHEGBOX~\cite{Frixione:2007vw} and \Sherpa~\cite{Gleisberg:2008ta}.
 ...
 \begin{figure}
    \centering
    \includegraphics[width = 0.9\textwidth]{Chapter3/Generator_ttH_modified}
